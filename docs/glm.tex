...
geometric expansion. The complete path is replayed so a newly added strong
endpoint remains the start of the continuation and all candidate scores have
the same path dependence. Expansion stops at an interior optimum, at zero or
