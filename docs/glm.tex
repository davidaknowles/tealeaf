...
\texttt{--posBias --dumpEqWeights}. Salmon learns separate observed and
expected fragment-position distributions in five transcript-length classes
and incorporates their ratio into alignment likelihoods and bias-corrected
effective lengths.
